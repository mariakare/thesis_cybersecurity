...
\begin{adjustbox}{width=1.35\textwidth,center}
\begin{tabular}{l p{0.23\textwidth} l l r r r r r r r}
\toprule
...
\end{tabular}
\end{adjustbox}
\caption{Test-set performance of the validation-selected representative configurations. P/R/F1 denote window-level precision, recall and F1. RP/RR/RF1 denote range-level precision, recall and F1. RFN denotes the number of missed attack ranges.}
\label{tab:selected_test_performance}
\end{table}


The selected CPS-GUARD configuration generalizes best to the test split. It achieves a window-level F1-score of 0.995 and detects all test attack ranges, resulting in a range-level F1-score of 1.000. This indicates that the validation performance was not only caused by overfitting to the validation period.
