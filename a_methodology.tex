...
\begin{figure}[htbp]
    ...
    \end{adjustbox}
    \caption{Example of a low-and-slow reconnaissance scenario injected into the customer 2 test split. The attack is visible as four separated bursts over the real benign background traffic, using 5-minute bins.}
