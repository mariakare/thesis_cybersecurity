...
% --TO BE FILLED IN--
\noindent
\textbf{Student name:} Maria Karegla\hfill \textbf{Student number:} r0825039
...
\begin{tabularx}{\linewidth}{@{}lXlX@{}}
\textbf{Title Bachelor’s or Master’s thesis:} & Early-Stage Reconnaissance Detection in Operational Technology Networks Using Conntrack-Based Anomaly Detection & \textbf{Supervisor:} & Prof.\,dr.\,ir.\ Bart Preneel \& Ir.\ Alex~Ongena \\
\end{tabularx}

\vspace{1em}

\textbf{Daily supervisor:} Ir. Lode~Mertens \& Ir. Thibault Van Win
...
(x) I \textbf{did use} GenAI Assistance. In this case \textbf{specify which ones} (e.g.\ ChatGPT, M365 Copilot, …): ChatGPT, Google Gemini.
...
\textbf{As a language assistant for reviewing or improving texts I wrote myself} & ChatGPT: Spelling and grammar checks & This use is similar to using spelling and grammar check tools. In general, you do not have to refer to such kind of GenAI use in the text. 
...
\end{itemize} \\ \hline
\textbf{For literature search} & - & This use is comparable to e.g.\ a Google Scholar search. You do not have to refer to such kind of GenAI use; \textbf{you only have to \href{https://bib.kuleuven.be/english/training-and-tutorials/citation}{refer} to the literature references you have checked and used} (without such references you would be committing \href{https://www.kuleuven.be/english/education/plagiarism/index}{plagiarism} and thus committing an irregularity).
...
\end{itemize} \\ \hline
\textbf{For generating visuals, video or audio} & - & Use of GenAI for generating visuals, audio or video is allowed except when it is prohibited by the teacher or the program of study. 
